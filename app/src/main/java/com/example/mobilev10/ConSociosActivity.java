...
public class ConSociosActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_con_socios);
    ...
    public void atualizarLista(){
        ArrayList arrayList = mydb.getAllSocios();
        ...
        listConsulta.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), SociosActivity.class);
    ...
    public void registrarSocio(View view){
        Bundle bundle = new Bundle();
        bundle.putInt("id", 0);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (preferencias.getBoolean("Automatico", false)) {
            if (event.sensor.getType() == Sensor.TYPE_LIGHT) {
                ...
                Intent intent = new Intent(ConSociosActivity.this, ConSociosActivity.class);
                startActivity(intent);
                this.overridePendingTransition(0, 0);
                finish();
            }
