...
public class ConAtividadesActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_con_atividades);
    ...
    public void atualizarLista(){
        ArrayList arrayList = mydb.getAllAtividades();
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (preferencias.getBoolean("Automatico", false)) {
            if (event.sensor.getType() == Sensor.TYPE_LIGHT) {
                ...
                Intent intent = new Intent(ConAtividadesActivity.this, ConAtividadesActivity.class);
                startActivity(intent);
                this.overridePendingTransition(0, 0);
                finish();
            }
